...
update msg model =
    case msg of
        ...
        DoThingNow str ->
            update (MsgQuietForOneSecond (provideInput DoThingLater)) { model | draft = str }

        DoThingLater ->
            ( { model | messages = model.messages ++ [ model.draft ], draft = "" }, Cmd.none )
...
view model =
    div [ style "margin" "1em" ]
        [ Html.textarea
            ...
            []
        , p [] [ text " I'll add a message below once you stop typing for one second." ]
        , model.messages
