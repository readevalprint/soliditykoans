					...
					return function (a) {
						...
						A3(
							...
							function (m) {
								...
								A2(author$project$Main$getLangModel, model.currentLanguage, model))));
				default:
					var lang = msg.a;
					var codeStr = msg.b;
					return function (m) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('failed', _function.fail)
					]))
			]),
		_List_fromArray(
			[
				...
				author$project$Main$displayAssertions(_function.assertions)
			]));
};
					...
					A2(
						...
						F2(
							function (_n2, _n3) {
								...
								return A2(elm$core$Basics$compare, function_a.loc, function_b.loc);
							}),
						contract.functions)))
			]));
};
				...
				_List_fromArray(
					[
						...
						A2(
							...
							pablohirafuji$elm_syntax_highlight$SyntaxHighlight$javascript('var a = {}; a /= 5;')))
					]))
			]));
};
